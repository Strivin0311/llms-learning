...
* [Development Stages](./dev/)
  * [Modeling](./dev/modeling/)
    ...
    * [Submodule Design](./dev/modeling/module.md)
      * [Activation Functions](./dev/modeling/module.md#activation-functions)
      * [Normalization](./dev/modeling/module.md#normalization)
  ...
  * [Training](./dev/train/)
    ...
    * [Automatic Mixed-Precision (AMP)](./dev/train/amp.md)
  ...
  * [Post-Training](./dev/post-train/)
    ...
    * [Quantization](./dev/post-train/quantize.md)
    * [Pruning](./dev/post-train/prune.md)
* [Abilities](./abilities/)
  ...
  * [Trasferability](./abilities/transfer.md)
* [Applications](./app/)

...
| model name | link |
|-|-|
| Llama-3.1-8B-Omni | [here](https://huggingface.co/ICTNLP/Llama-3.1-8B-Omni) |
...
tag: `Phi-3` | `Phi-3.5` | `Phi` | `SLM` | `Microsoft`

paper link: [here](https://arxiv.org/pdf/2404.14219)

modelhub link: [here](https://huggingface.co/collections/microsoft/phi-3-6626e15e9585a200d2d761e3)

follow-up work: [here](https://arxiv.org/pdf/2412.08905)
